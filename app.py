...
def create_video_with_audio_and_subtitles(background_clips_folder, output_folder):
    ...
    video_file = add_audio_to_video(background_clips_folder, audio_file, output_video=f"final_video{i + 1}.mp4", output_folder=output_folder)

    # Add subtitles to the final video
    video_with_subtitles = add_subtitles_to_video(video_file, script_text, output_video_with_subs=f"final_with_subtitles{i+1}.mp4", output_folder=output_folder)
...
if __name__ == "__main__":
    ...
    create_video_with_audio_and_subtitles(background_clips_folder, output_folder="my_videos")
